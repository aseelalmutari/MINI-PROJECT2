...
This project demonstrates a fully vectorized linear transformation pipeline using pure NumPy.
It follows best practices in numerical computing and avoids Python loops completely.
